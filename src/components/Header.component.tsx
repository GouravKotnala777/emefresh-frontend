...
function Header({screenWidth}:{screenWidth:number}) {
    ...
    return(//[box-shadow:0px_0px_1px_0.1px_var(--color-neutral-500)_inset]
        <header className="fixed top-0 left-0 w-full pt-2 z-20">
                    ...
                    >
                        ...
                        <div className="h-[76%] overflow-y-scroll thin_scrollbar px-3 relative">
                            ...
                            <div className="text-neutral-700 dark:text-neutral-300 text-sm flex flex-col">
                                ...
                                <NavLink to={"/create_product"} className="flex items-center gap-2 hover:bg-neutral-200/50 dark:hover:bg-neutral-700/50 py-2 px-3 rounded-lg"
                                    onClick={closeSettingHandler}
                                >
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="size-4">
                            ...
                            {/*<div className="text-neutral-700 dark:text-neutral-300 text-sm flex flex-col gap-1">
                                ...
                                <NavLink to={"/aaaaaaaaa"} className="flex items-center gap-2 hover:bg-neutral-200/50 dark:hover:bg-neutral-700/50 py-2 px-3 rounded-lg">
                                    <span className=""><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M4 14a1 1 0 0 1-.78-1.63l9.9-10.2a.5.5 0 0 1 .86.46l-1.92 6.02A1 1 0 0 0 13 10h7a1 1 0 0 1 .78 1.63l-9.9 10.2a.5.5 0 0 1-.86-.46l1.92-6.02A1 1 0 0 0 11 14z"></path></svg></span>
                                    <span>Project2</span>
                                </NavLink>
                                <NavLink to={"/aaaaaaaaa"} className="flex items-center gap-2 hover:bg-neutral-200/50 dark:hover:bg-neutral-700/50 py-2 px-3 rounded-lg">
            ...
            <div className="bg-linear-90 from-green-500 to-pink-500 dark:from-green-800 dark:to-pink-800 border-y border-blue-600 dark:border-neutral-800 mx-2">
                ...
                `}>
                    <div className="flex justify-between items-center">
                        <div className="text-neutral-700 dark:text-neutral-200">
                            <div className="size-11 rounded-full overflow-hidden relative">
                                <NavLink to="/" className={`z-2 absolute top-0 left-0 h-full w-full rounded-full p-1`}>
                        ...
                        <div className="flex items-center gap-6 text-neutral-700 dark:text-neutral-200">
                            ...
                            >
                                ...
                                <span className="absolute -top-2 -right-2 text-xs bg-red-500 w-4 h-4 grid place-items-center rounded-full">{totalCartItems}</span>
                            </NavLink>
